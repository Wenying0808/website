...
export const ProjectCard = ({ projectTitle, projectDescription, chipNames, img, projectLink }: Props) => {
    return(
        <Link
            href={projectLink}
            className="xs:max-w-xs sm:max-w-smm md:max-w-md flex-col space-y-0 bg-background-light-0 dark:bg-background-dark-1 dark:border-2 dark:border-solid dark:border-gray-800 dark:hover:border-gray-400 rounded-2xl shadow-md hover:shadow-card-hover cursor-pointer">
